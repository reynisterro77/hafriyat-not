...
<div class="wrapper fadeInDown">
    ...
    if (isset($_POST['users_register'])){
        ...
        if ($_POST['users_password']===$_POST['users_password_repeat']){
            $sonuc=$db->adminInsert(htmlspecialchars($_POST['users_mail']),htmlspecialchars($_POST['users_name']),htmlspecialchars($_POST['users_password']),htmlspecialchars($_POST['users_telno']));

            if ($sonuc['status']==1){?>
                <div class="alert alert-success">Kayıt Başarılı</div>
            <?php header('Refresh: 1; url=login'); } elseif ($sonuc['status']==2){?>
                <div class="aler alert-danger">Bu eposta kullanılmış.</div>
            <?php  }
        }else{?>
            <div class="alert alert-danger">Şifreler Birbirleriyle Uyuşmuyor.</div>
        <?php }
    }
    ...
    <div id="formContent">
        ...
        <form action="" method="post">
            <input type="email"  class="fadeIn" required name="users_mail" placeholder="Mailinizi Giriniz">
            <input type="text"  class="fadeIn" required name="users_name" placeholder="Şirket İsmi Veya İsminiz">
            <input type="password"  class="fadeIn" required min="6" name="users_password" placeholder="Şifre Giriniz">
            <input type="password"  class="fadeIn" required min="6" name="users_password_repeat" placeholder="Şifrenizi Tekrar Giriniz">
            <input type="text"  class="fadeIn" id="phone" required name="users_telno" placeholder="İrtibat Numaranız">
            <input type="submit" class="fadeIn" name="users_register" value="Kayıt Ol">
        </form>

        <div id="formFooter">
            <a class="underlineHover" href="login">Giriş Yap</a>
